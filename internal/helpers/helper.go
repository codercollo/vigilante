...
//IsAuthenticated checks if user is logged in
 ...
 func RenderPage(w http.ResponseWriter, r *http.Request, templateName string, variables, data interfacer{}) error {
	   vars vars jet.VarMapconst
